...
export default async function ReasoningPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-14">
      ...
      {"This service provides a check upon syllogisms, investigates plausibility, and reads Bernoulli businesses."}
      ...
      <section className="mt-12">
        ...
        {syllogism ? (
          <div className="mt-3 max-w-prose">
            ...
            {"This service checked the syllogism for validity, and determined that it was invalid."}
      ...
      <section className="mt-12">
        ...
        {plausibility ? (
          <div className="mt-3">
            ...
            {"This calculation shows that the probability of a flagged case being real fraud is 0.155."}
          </div>
        ) : (
      ...
      <section className="mt-12">
        ...
        {bernoulli ? (
          <div className="mt-3">
            ...
            {"This Bernoulli business has an expected payoff of $16 on average."}
          </div>
        ) : (
